  ...
  const services = [
    {
      ...
      description: "Reliable door-to-door deliveries across all provinces in Luzon, Visayas, and Mindanao, ensuring your goods arrive safely and on time.",
      image: "/images/header-image1.jpg",
    },
    {
      title: "Container Hauling",
      description: "Efficient hauling of 20ft and 40ft containers from ports to warehouses or business locations nationwide.",
      image: "/images/header-image1.jpg",
    },
    {
      title: "Closed Van Transport",
      description: "Secure, weather-protected transport for goods requiring enclosed delivery using our fleet of closed vans.",
      image: "/images/header-image1.jpg",
    },
    {
      title: "Wing Van & Trailer Trucks",
      description: "High-capacity wing van and trailer truck services for bulk shipments and large-volume logistics requirements.",
      image: "/images/header-image1.jpg",
    },
  ];
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden rounded-md">
        ...
        <div className="absolute inset-0 bg-text-primary/50 flex flex-col justify-center items-center text-center px-4">
          ...
          <p className="text-bg-primary/90 text-lg md:text-2xl max-w-2xl">
            Logistics solutions across Luzon, Visayas, and Mindanao — built for manufacturers, distributors, retail chains, and SMEs.
          </p>
        </div>
      </section>
